...
public class BasePackageTemplate implements Template<org.xomda.model.Package> {

	@Override
	public void generate(final org.xomda.model.Package pkg, final TemplateContext context) throws IOException {
		processList(pkg::getPackageList, sneaky(BasePackageTemplate.this::generate), context);
