 ...
 * <p>
 * It should hold all settings which are externally configurable.
 * Addons, like the CLI or the Gradle plugin, will each parse their settings into a Configuration.
 */
public interface Configuration {
    ...
    default void setLogLevel(Object logLevel) {
        if (logLevel instanceof Enum<?> en) en.name();
        else if (logLevel instanceof CharSequence cs) setLogLevel(cs.toString());
    }
