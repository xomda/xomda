...
public class TemplateFormat {
    ...
    /**
     * The patterns we're going to provide will typically contain a lot of curly braces,
     * which we don't want to start escaping all he time.
     * This helper will perform that escaping for us.
     */
    ...
    /**
     * Format a given text (pattern) which contains placeholders in the form of <code>{0}</code>, <code>{1}</code>, <code>{2}</code>, ...
     * and replace those placeholders with their respective counterparts, found in the given "</code>args</code>" varargs parameter.
     */
