 ...
 * <p>
 * It's a proxy for a {@link CsvObject} that implements the Java interface
 * which is bound to the corresponding {@link CsvSchema object}.
 */
class CsvProxyObject implements InvocationHandler {
    ...
    public Object invoke(final Object proxy, final Method method, final Object[] args) throws Throwable {
        ...
        if (name.startsWith("get") && name.length() > 3) {
            ...
            return result instanceof CsvObject csvObject
                ? csvObject.getProxy()
                : result;
        }
        return null;
